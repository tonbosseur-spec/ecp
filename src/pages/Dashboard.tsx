...
import { Loader2, Calendar, Users, PlusCircle, Search, Copy, CheckCircle2, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="p-4 sm:p-6 max-w-md mx-auto pb-24 relative">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Vos Formations</h1>
          <p className="text-sm text-gray-500 mt-1">Gérez vos événements et inscriptions</p>
        </div>
      </div>
