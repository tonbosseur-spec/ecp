...
export default function DownloadAppPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-purple-500/30 selection:text-purple-200 overflow-x-hidden pt-safe pb-safe">
      {/* Background Effects */}
