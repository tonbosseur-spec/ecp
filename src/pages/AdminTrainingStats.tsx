...
export default function AdminTrainingStats() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/80 p-4 sm:p-6 lg:p-8 font-sans pb-24 w-full">
      <div className="max-w-7xl mx-auto space-y-6">

        {/* Header Bar */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 sm:p-7 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden">
          <div className="flex items-center gap-4 relative z-10">
            <button
              onClick={() => navigate('/admin/training')}
              className="p-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-2xl transition-all flex items-center justify-center shrink-0 cursor-pointer"
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-gray-500 font-semibold">{trainingSessions.length} entraînements répertoriés</span>
              </div>
              <h1 className="text-2xl sm:text-3xl font-black text-gray-900 tracking-tight mt-1">
                Suivi des Séances d'Entraînement
              </h1>
              <p className="text-xs sm:text-sm text-gray-500 font-medium mt-0.5">
                Statistiques détaillées, performances des clients et bilan question par question.
              </p>
            </div>
          </div>

          <div className="flex items-center gap-2.5 self-start md:self-center shrink-0 relative z-10">
            <button
              onClick={handleRefresh}
              disabled={refreshing || loading}
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 text-xs font-bold rounded-xl transition-all cursor-pointer"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl transition-all shadow-sm cursor-pointer"
            >
            ...
            <Link
              to="/admin/training"
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl transition-all shadow-sm cursor-pointer"
            >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
          ...
          <div className="bg-white p-5 rounded-3xl border border-gray-100 shadow-xs space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Nombre d'essais</span>
            ...
            <p className="text-[11px] text-gray-500 font-medium">
              Par <span className="font-bold text-gray-800">{kpiStats.uniqueClients}</span> client(s) unique(s)
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-3xl border border-gray-100 shadow-xs space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Note Moyenne</span>
              <div className="w-9 h-9 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center font-bold text-xs">
                <Target className="w-4.5 h-4.5" />
              </div>
            </div>
            <div className="text-2xl sm:text-3xl font-black text-gray-900 tracking-tight flex items-baseline gap-1">
              <span>{kpiStats.avgScore}%</span>
              <span className="text-xs font-bold text-gray-400">/ 100%</span>
            </div>
            <p className="text-[11px] text-gray-500 font-medium">
              Score moyen par tentative
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-3xl border border-gray-100 shadow-xs space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Taux de validation</span>
          ...
          <div className="bg-white p-5 rounded-3xl border border-gray-100 shadow-xs space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Temps Moyen</span>
          ...
          {/* KPI 5: Exercices Créés */}
          <div className="bg-white p-5 rounded-3xl border border-gray-100 shadow-xs space-y-2 col-span-2 lg:col-span-1">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Catalogue</span>
              <div className="w-9 h-9 rounded-2xl bg-purple-50 text-purple-600 flex items-center justify-center font-bold text-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 text-xs bg-gray-50 border border-gray-200 rounded-xl font-medium text-gray-900 focus:bg-white focus:border-indigo-500 focus:outline-none transition-all"
              />
            </div>
            ...
            <div>
              <select
                ...
                className="w-full px-3 py-2.5 text-xs bg-gray-50 border border-gray-200 rounded-xl font-medium text-gray-900 focus:bg-white focus:border-indigo-500 focus:outline-none transition-all cursor-pointer"
              >
                <option value="ALL">Tous les entraînements ({trainingSessions.length})</option>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-gray-100 shadow-xs space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-base font-extrabold text-gray-900 tracking-tight">
                  Nombre d'Essais & Note Moyenne par Entraînement
                </h3>
                <p className="text-xs text-gray-500 font-medium">
                  Nombre de tentatives enregistrées et score moyen obtenu pour chaque séance.
                </p>
              </div>
            ...
            {loading ? (
              ...
              <div className="h-64 flex flex-col items-center justify-center text-center text-gray-400 space-y-2">
                ...
                <p className="text-xs font-medium">Aucune tentative enregistrée pour les filtres sélectionnés.</p>
              </div>
            ) : (
              <div className="h-72 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={sessionChartData} margin={{ top: 10, right: 10, left: -20, bottom: 20 }}>
                    ...
                    <Tooltip 
                      contentStyle={{ backgroundColor: '#ffffff', borderRadius: '16px', border: '1px solid #e2e8f0', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1)', fontSize: '12px' }}
                    />
                    <Legend wrapperStyle={{ fontSize: '11px', paddingTop: '10px' }} />
                    <Bar yAxisId="left" dataKey="attemptsCount" name="Nombre d'essais" fill="#6366f1" radius={[6, 6, 0, 0]} barSize={28} />
                    <Bar yAxisId="right" dataKey="avgScore" name="Note Moyenne (%)" fill="#10b981" radius={[6, 6, 0, 0]} barSize={28} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            )}
          ...
          <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-xs space-y-4">
            <div>
              ...
              <p className="text-xs text-gray-500 font-medium">
                Répartition par tranches de score (%)
              </p>
            </div>
                ...
                <div className="grid grid-cols-2 gap-2 pt-2 border-t border-gray-100 text-xs">
                  {scoreDistributionData.map((item, idx) => (
                    <div key={idx} className="flex items-center gap-1.5">
                      ...
                      <span className="text-[11px] font-extrabold text-gray-900">{item.value}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-gray-100 shadow-xs space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-base font-extrabold text-gray-900 tracking-tight">
                  Évolution des Tentatives d'Entraînement
                </h3>
                <p className="text-xs text-gray-500 font-medium">
                  Nombre quotidien de sessions d'entraînement lancées.
                </p>
              </div>
            ...
            {loading ? (
              ...
              <div className="h-56 flex items-center justify-center text-center text-gray-400 text-xs">
          ...
          <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-xs space-y-4">
            <div>
              ...
              <p className="text-xs text-gray-500 font-medium">
                Volume de questions réussies selon la typologie d'exercice.
              </p>
            </div>
            ...
            {loading ? (
              ...
              <div className="h-56 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={exerciseTypePerformance} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f1f5f9" />
        ...
        {/* Detailed Table Section: Clients & Training Attempts */}
          ...
          <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h3 className="text-lg font-extrabold text-gray-900 tracking-tight flex items-center gap-2">
                ...
                <span>Participation des Clients & Résultats Détaillés</span>
              </h3>
              <p className="text-xs text-gray-500 font-medium mt-0.5">
                Consultez chaque tentative effectuée par un apprenant avec l'accès au détail question par question.
              </p>
            </div>

            <div className="text-xs font-bold text-gray-500 bg-gray-50 px-3.5 py-1.5 rounded-full border border-gray-100 shrink-0">
          ...
          {loading ? (
            ...
            <div className="p-12 text-center text-gray-400 space-y-3">
              ...
              <p className="text-xs text-gray-500 max-w-md mx-auto">
                Aucune séance d'entraînement n'a encore été réalisée correspondant aux critères de recherche actuels.
              </p>
            </div>
          ) : (
      ...
      {/* Modal: Detail Question par Question */}
      {selectedAttemptModal && (
        ...
        >
          <div 
            className="bg-white rounded-3xl max-w-2xl w-full p-6 sm:p-7 shadow-2xl border border-indigo-100 relative space-y-5 max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200"
            onClick={e => e.stopPropagation()}
          >
            {/* Header */}
            <div className="flex items-center justify-between pb-4 border-b border-gray-100">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-2xl bg-indigo-600 text-white flex items-center justify-center font-extrabold text-sm shrink-0 shadow-md shadow-indigo-200">
                  <Brain className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-base font-extrabold text-gray-900">
                    Bilan par Question : {selectedAttemptModal.client_name}
                  </h3>
                  <p className="text-xs text-gray-500 font-medium">
              ...
              <button
                type="button"
                onClick={() => setSelectedAttemptModal(null)}
                className="p-2 text-gray-400 hover:text-gray-800 hover:bg-gray-100 rounded-xl transition-all cursor-pointer"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100 text-xs">
              <div>
                <span className="text-gray-500 font-semibold block text-[11px]">Note globale</span>
                <span className={`font-black text-lg ${selectedAttemptModal.score_percentage >= 70 ? 'text-emerald-600' : 'text-rose-600'}`}>
                  {selectedAttemptModal.score_percentage}%
                </span>
              </div>
              <div>
                <span className="text-gray-500 font-semibold block text-[11px]">Statut</span>
                <span className="font-bold text-gray-900">
                  {selectedAttemptModal.is_passed ? '🎉 Validé (≥ 70%)' : '❌ Non validé'}
                </span>
              </div>
              <div>
                <span className="text-gray-500 font-semibold block text-[11px]">Durée de l'essai</span>
            ...
            {/* Questions List */}
            <div className="overflow-y-auto space-y-4 flex-1 pr-1.5 my-1 custom-scrollbar">
              {(() => {
                const sessionObj = trainingSessions.find(s => s.id === selectedAttemptModal.training_session_id);
                const exercisesList = sessionObj?.exercises || [];
                ...
                return exercisesList.map((ex, idx) => {
                  const exAttemptRecord = selectedAttemptModal.exercise_attempts.find(ea => ea.exercise_id === ex.id);
                  const isCorrect = exAttemptRecord?.is_correct || false;
                  const score = exAttemptRecord?.score || 0;
                  const ansData = exAttemptRecord?.answer_data || {};

                  return (
                    <div key={ex.id} className="p-4 bg-white rounded-2xl border border-gray-200/90 shadow-2xs space-y-3">
                      ...
                      <div className="flex items-center justify-between gap-2 border-b border-gray-100 pb-2.5">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {isCorrect ? (
                            <span className="px-2.5 py-0.5 bg-emerald-100 text-emerald-800 font-extrabold text-[10px] rounded-md flex items-center gap-1">
                              <Check className="w-3 h-3" /> Validé ({score}%)
                            </span>
                          ) : (
                            <span className="px-2.5 py-0.5 bg-rose-100 text-rose-800 font-extrabold text-[10px] rounded-md flex items-center gap-1">
                      ...
                      {/* Instructions */}
                      <p className="text-xs text-gray-700 leading-relaxed font-normal bg-gray-50/70 p-3 rounded-xl border border-gray-100">
                        {ex.instructions}
                      </p>

                      {/* Detail Answer Logic */}
                      {ex.exercise_type === 'qcm' && ex.options && (
                        <div className="space-y-1.5 pt-1 text-xs">
                          ...
                          <div className="grid grid-cols-1 gap-1.5">
                            {ex.options.map((opt, oIdx) => {
                              const isSelectedByClient = ansData?.selected_option_index === oIdx;
                              const isCorrectOption = ex.correct_option_index === oIdx;
                              ...
                              return (
                                <div key={oIdx} className={`p-2.5 rounded-xl border flex items-center justify-between ${bgStyle}`}>
                                  <div className="flex items-center gap-2">
                                    <span className="w-5 h-5 rounded-md bg-white text-gray-700 font-extrabold text-[10px] flex items-center justify-center border border-gray-200">
                        ...
                        <div className="space-y-2 pt-1 text-xs">
                          <div className="flex items-center justify-between p-2.5 bg-gray-50 rounded-xl border border-gray-200">
                            ...
                            <span className="font-extrabold text-indigo-700">
                              {ansData?.passed_tests !== undefined 
                                ? `${ansData.passed_tests} / ${ansData.total_tests || 0} tests validés`
                                : 'Code exécuté'
                              }
                            </span>
                          </div>
            ...
            <div className="pt-3 border-t border-gray-100 flex items-center justify-end">
              <button
                type="button"
                onClick={() => setSelectedAttemptModal(null)}
                className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl transition-all cursor-pointer shadow-sm"
              >
                Fermer le bilan
              </button>
            </div>
